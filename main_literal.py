...
from model import DistMultLiteral, ComplexLiteral, ConvELiteral, DistMultLiteral_gate,ComplexLiteral_gate, ConvELiteral_gate, DistMultLiteral_gate_text, ComplexLiteral_gate_text, ConvELiteral_gate_text, DistMultLiteral_text
...
def main():
    ...
    if Config.epochs != 0:
        ...
        # Load literals
        numerical_literals = np.load(f'data/{Config.dataset}/literals/num_plus_att.npy', allow_pickle=True) #change here
        text_literals = np.load(f'data/{Config.dataset}/literals/att_txt_literals.npy', allow_pickle=True) #text_literals
        ...
        elif Config.model_name == 'DistMult_glin_text':
            model = DistMultLiteral_text(vocab['e1'].num_token, vocab['rel'].num_token, numerical_literals, text_literals)
